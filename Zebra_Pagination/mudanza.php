...
<section class="container-fluid" style="margin-top:10%">
    <h1 style="color:red;">Servicio de Mudanzas</h1>    
    ...
    <div class="row">
        ...
        <?php $I=0; $consulta = mysqli_query($conn,"SELECT* FROM wp_properties WHERE id_publication_type='2'");
...
<div class="col-lg-6">    
<div class="demo-card-wide mdl-card mdl-shadow--2dp" style="width: 100%; height:400px;  margin-bottom:2%; margin-top:1%;">
  ...
  <div class="mdl-card__supporting-text" style="height:150px;">
      <div class="row">
          ...
          <div class="col-md-7" style="text-align: right;">
              <h3>Precio:<br> <?php echo $REGISTRO['price']; ?> S/</h3>
          </div>
         </div>
  </div>
